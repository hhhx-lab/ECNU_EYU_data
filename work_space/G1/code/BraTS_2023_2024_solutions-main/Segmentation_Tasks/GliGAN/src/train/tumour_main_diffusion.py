...
def __main__():
    ...
    parser.add_argument("--logdir", default="brats2026_diffusion", type=str, help="Directory to save the experiment")
    parser.add_argument("--batch_size", default=2, type=int, help="Batch size")
    parser.add_argument("--num_workers", default=2, type=int, help="Number of workers")
    parser.add_argument("--in_channels", default=None, type=int,
                        help="Number of input channels (auto: BRATS_2023=4, BRATS_2024/2026=5). "
    ...
    elif "brats" in dl and "2026" in dl and "goat" not in dl and "meningioma" not in dl:
        args.dataset = "BRATS_2026"
