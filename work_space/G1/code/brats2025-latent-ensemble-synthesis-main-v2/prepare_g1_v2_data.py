#!/usr/bin/env python3
"""Prepare G1 V2 data links from the raw BraTS-MET Task1 directory.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create data/input and data/input_inference for G1 V2."
    )
    parser.add_argument(
        "--raw-root",
        type=Path,
...
def main() -> None:
    ...
    manifest_path = data_dir / "g1_v2_data_placement_manifest.csv"
