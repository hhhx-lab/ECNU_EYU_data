#!/usr/bin/env python3
"""Exclude cases with unreadable or out-of-contract segmentation labels from G1 V2."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report-csv",
        type=Path,
        default=Path("data/g1_v2_label_filter_report.csv"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("data/g1_v2_label_filter_summary.json"),
    )
