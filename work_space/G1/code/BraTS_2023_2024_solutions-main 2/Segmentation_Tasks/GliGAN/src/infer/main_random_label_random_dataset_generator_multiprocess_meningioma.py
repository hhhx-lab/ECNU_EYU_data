...
def load_generators(args):
    ...
    if torch.cuda.is_available():
        generator_t1c.cuda()
    generators_dic = {'scan_t1c':generator_t1c}
...
def insert_tumour(args, generators_dic, healthy_scan_dic, original_label, new_label, x, y, z, registo_lista_label, source_original_label, source_original_healthy_scan):
    ...
    print(f"healthy_scan_crop_dic.shape: {healthy_scan_crop_dic['scan_t1c'].shape}")
...
def generating(args):
    ...
    for ids_scan_n, ids_scan in enumerate(label_ids_list):
        ...
        ficheiro_scan_dic={'scan_t1c':registo_lista_scan['scan_t1c']}
        healthy_scan_dic={}
...
if __name__ == "__main__":
    #python main_random_dataset_generator.py --csv_path /projects/brats2023_a_f/BRAINTUMOUR/data/brats21_96_2023.csv --save_folder /projects/brats2023_a_f/Synthetic_dataset --g_t1c_n 400000  --g_t1_n 400000 --g_t2_n 400000  --g_flair_n 400000
    __main__()
