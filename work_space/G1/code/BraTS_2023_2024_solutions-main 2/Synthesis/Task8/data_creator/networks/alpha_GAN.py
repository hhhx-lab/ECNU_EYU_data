...
#***********************************************
# Alfa-GAN based implementation (for image sizes of 64x64x64)
#***********************************************
...
class Discriminator(nn.Module):
    def __init__(self, channel=512,out_class=1,is_dis =True):
        ...
        self.conv1 = SN(nn.Conv3d(3, channel//8, kernel_size=4, stride=2, padding=1))
...
class Encoder(nn.Module):
    def __init__(self, channel=512,out_class=1,is_dis =True):
        ...
        self.conv1 = nn.Conv3d(3, channel//8, kernel_size=4, stride=2, padding=1)
...
class Generator(nn.Module):
    def __init__(self, noise:int=100, channel:int=64):
        ...
        self.tp_conv5 = nn.Conv3d(_c, 3, kernel_size=3, stride=1, padding=1, bias=False)
