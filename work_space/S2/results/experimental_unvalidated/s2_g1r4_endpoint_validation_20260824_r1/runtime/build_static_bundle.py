...
REMOTE_RESULT_ROOT = REMOTE_PROJECT_ROOT / (
    ...
    "s2_g1r4_endpoint_validation_20260824_r1"
)
...
def main() -> None:
    ...
    g1_code_root = project_root / "work_space/G1/code/brats2025-latent-ensemble-synthesis-main-v3"
    g1_code_files = (
        "configs.py",
        "synthesis/utils.py",
        "synthesis/spatial.py",
        "synthesis/pipeline.py",
        "models/encdec/unet.py",
        "models/bbdm/unet.py",
        "models/bbdm/condition_tokens.py",
        "models/bbdm/bb_scheduler.py",
    )
    g1_code_hashes = {}
    ...
    plan = {
        ...
        "experiment": "g1_r4_to_s2_endpoint_validation_20260824_r1",
