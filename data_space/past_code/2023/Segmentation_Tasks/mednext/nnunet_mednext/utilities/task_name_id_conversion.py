...
from nnunet_mednext.paths import nnUNet_raw_data, preprocessing_output_dir, nnUNet_cropped_data, network_training_output_dir
...
def convert_id_to_task_name(task_id: int):
    ...
    print(f"nnUNet_raw_data: {nnUNet_raw_data}")
    ...
    print(f"candidates_raw: {candidates_raw}")
    print(f"candidates_cropped: {candidates_cropped}")
