...
from nnunet_mednext.network_architecture.generic_modular_UNet import get_default_network_config
from nnunet_mednext.network_architecture.custom_modules.custom_networks.CoTr.ResTransUNet import ResTranUnet as ResTransUNet_orig
