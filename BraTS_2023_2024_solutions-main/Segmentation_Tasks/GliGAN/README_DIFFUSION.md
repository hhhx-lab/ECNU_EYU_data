...
`--in_channels` 根据 dataset 自动检测（BRATS_2024=5, BRATS_2023=4），无需手动指定。
...
python src/infer/generate_from_label.py \
    --label_path DataSet/my_data/BraTS-GLI-00001-000/BraTS-GLI-00001-000-seg.nii.gz \
