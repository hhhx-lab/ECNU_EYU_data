...
# GAN-based training has been replaced by diffusion models.
# See: src/networks/DiffusionNetwork.py
#      src/train/tumour_main_diffusion.py
# ============================================================
...
class Discriminator(nn.Module):
    def __init__(self, args, channel=768, use_sigmoid=False):
        ...
        self.conv6 = nn.Conv3d(self.channel, self.out_channels, kernel_size=(3,3,3), stride=(1,1,1), padding=0)
